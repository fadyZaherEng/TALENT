...
class _AreaApiService implements AreaApiService {
  ...
  Future<HttpResponse<TalentLinkResponse<List<RemoteArea>>>> allArea(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<TalentLinkResponse<List<RemoteArea>>>>(
            Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
                ...
                .compose(
                  _dio.options,
                  'Mobile/UpdateProfile/GetAreaList',
    ...
    final value = TalentLinkResponse<List<RemoteArea>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<RemoteArea>(
                  (i) => RemoteArea.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
