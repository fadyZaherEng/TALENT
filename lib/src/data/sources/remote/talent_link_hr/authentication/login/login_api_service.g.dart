...
class _LoginApiService implements LoginApiService {
  ...
  Future<HttpResponse<TalentLinkResponse<RemoteUser>>> login(
      TalentLinkHrRequest<LoginRequest> request) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<TalentLinkResponse<RemoteUser>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TalentLinkResponse<RemoteUser>.fromJson(
      _result.data!,
