...
class _ForgotPasswordApiService implements ForgotPasswordApiService {
  ...
  Future<HttpResponse<TalentLinkResponse<RemoteForgotPasswordState>>>
      forgotPassword(TalentLinkHrRequest<ForgotPasswordRequest> request) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<
        HttpResponse<TalentLinkResponse<RemoteForgotPasswordState>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TalentLinkResponse<RemoteForgotPasswordState>.fromJson(
      _result.data!,
      (json) =>
          RemoteForgotPasswordState.fromJson(json as Map<String, dynamic>),
    );
