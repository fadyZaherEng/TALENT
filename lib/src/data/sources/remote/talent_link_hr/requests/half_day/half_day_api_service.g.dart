...
class _HalfDayApiService implements HalfDayApiService {
  ...
  Future<HttpResponse<TalentLinkResponse<RemoteCalculateInCaseHalfDayLeave>>>
      calculateInCaseHalfDay(TalentLinkHrRequest<dynamic> request) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_setStreamType<
        HttpResponse<
            TalentLinkResponse<RemoteCalculateInCaseHalfDayLeave>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          'Mobile/MyRequests/CalculateInCaseHalfDayLeave',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
    ...
    final value =
        TalentLinkResponse<RemoteCalculateInCaseHalfDayLeave>.fromJson(
      _result.data!,
      (json) => RemoteCalculateInCaseHalfDayLeave.fromJson(
  ...
  @override
  Future<HttpResponse<TalentLinkResponse<dynamic>>> insertHalfDayLeave(
    String requestBody,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      contentType: 'multipart/form-data',
            ...
            .compose(
              _dio.options,
              'Mobile/RequestsList/InsertHalfDayLeave',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
