...
class AirTicketDetailsShimmerWidget extends StatefulWidget {
  final bool isFromMyRequest;
  final int transactionId;
  final int referenceId;

  const AirTicketDetailsShimmerWidget({
    super.key,
  ...
  @override
  State<AirTicketDetailsShimmerWidget> createState() =>
      _AirTicketDetailsShimmerWidgetState();
}

class _AirTicketDetailsShimmerWidgetState
    extends State<AirTicketDetailsShimmerWidget> {
  @override
