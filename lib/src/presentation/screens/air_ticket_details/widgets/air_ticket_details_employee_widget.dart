...
class AirTicketDetailsEmployeeWidget extends StatefulWidget {
  final GetAirTicketDetails getAirTicketDetails;

  const AirTicketDetailsEmployeeWidget({
    super.key,
    required this.getAirTicketDetails,
  });

  @override
  State<AirTicketDetailsEmployeeWidget> createState() =>
      _AirTicketDetailsEmployeeWidgetState();
}

class _AirTicketDetailsEmployeeWidgetState
    extends State<AirTicketDetailsEmployeeWidget> {
  @override
          ...
          child: Column(
            children: [
              _getBasicRequestItemContent(
                ...
                value: widget.getAirTicketDetails.employee!.name,
              ),
              const SizedBox(
                height: 20,
              ),
              _getBasicRequestItemContent(
                ...
                value:
                    widget.getAirTicketDetails.employee!.basicSalary.toString(),
              ),
              const SizedBox(
                height: 20,
              ),
              _getBasicRequestItemContent(
                ...
                value:
                    widget.getAirTicketDetails.employee!.gosiSalary.toString(),
              ),
              const SizedBox(
                height: 20,
              ),
              _getBasicRequestItemContent(
                ...
                value: widget.getAirTicketDetails.employee!.positionName
                    .toString(),
              ),
              const SizedBox(
                height: 20,
              ...
              _getBasicRequestItemContent(
                ...
                value: widget.getAirTicketDetails.employee!.joiningDate
                    .toString()
                    .split("T")[0],
              ),
            ],
