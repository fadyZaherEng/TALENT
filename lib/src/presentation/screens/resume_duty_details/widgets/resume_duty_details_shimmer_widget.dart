...
class ResumeDutyDetailsShimmerWidget extends StatefulWidget {
  final bool isFromMyRequest;
  final int transactionId;
  final int referenceId;

  const ResumeDutyDetailsShimmerWidget({
    super.key,
  ...
  @override
  State<ResumeDutyDetailsShimmerWidget> createState() =>
      _ResumeDutyDetailsShimmerWidgetState();
}

class _ResumeDutyDetailsShimmerWidgetState
    extends State<ResumeDutyDetailsShimmerWidget> {
  @override
