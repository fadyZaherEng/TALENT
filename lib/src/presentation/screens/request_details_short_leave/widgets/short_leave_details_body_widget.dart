...
import 'package:talent_link/src/presentation/screens/request_details_short_leave/widgets/short_leave_details_employee_widget.dart';
import 'package:talent_link/src/presentation/screens/request_details_short_leave/widgets/short_leave_details_widget.dart';
import 'package:talent_link/src/presentation/widgets/custom_button_widget.dart';

class ShortLeaveDetailsContentWidget extends StatefulWidget {
  ...
  const ShortLeaveDetailsContentWidget({
    super.key,
  ...
  @override
  State<ShortLeaveDetailsContentWidget> createState() =>
      _ShortLeaveDetailsContentWidgetState();
}

class _ShortLeaveDetailsContentWidgetState extends State<ShortLeaveDetailsContentWidget> {
  @override
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ShortLeaveDetailsWidget(getShortLevelDetails: widget.getShortLevelDetails),
        ShortLeaveDetailsEmployeeWidget(
            getShortLevelDetails: widget.getShortLevelDetails),
