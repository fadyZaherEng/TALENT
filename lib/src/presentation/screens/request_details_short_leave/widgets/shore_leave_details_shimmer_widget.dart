...
class ShortLeaveDetailsShimmerWidget extends StatefulWidget {
  final bool isFromMyRequest;
  final int transactionId;
  final int referenceId;

  const ShortLeaveDetailsShimmerWidget({
    super.key,
  ...
  @override
  State<ShortLeaveDetailsShimmerWidget> createState() =>
      _ShortLeaveDetailsShimmerWidgetState();
}

class _ShortLeaveDetailsShimmerWidgetState
    extends State<ShortLeaveDetailsShimmerWidget> {
  @override
