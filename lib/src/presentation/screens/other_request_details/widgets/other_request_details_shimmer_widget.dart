...
class OtherRequestDetailsShimmerWidget extends StatefulWidget {
  final bool isFromMyRequest;
  final int transactionId;
  final int referenceId;

  const OtherRequestDetailsShimmerWidget({
    super.key,
  ...
  @override
  State<OtherRequestDetailsShimmerWidget> createState() =>
      _OtherRequestDetailsShimmerWidgetState();
}

class _OtherRequestDetailsShimmerWidgetState
    extends State<OtherRequestDetailsShimmerWidget> {
  @override
