...
class HalfDayDetailsShimmerWidget extends StatefulWidget {
  final bool isFromMyRequest;
  final int transactionId;
  final int referenceId;

  const HalfDayDetailsShimmerWidget({
    super.key,
  ...
  @override
  State<HalfDayDetailsShimmerWidget> createState() =>
      _HalfDayDetailsShimmerWidgetState();
}

class _HalfDayDetailsShimmerWidgetState
    extends State<HalfDayDetailsShimmerWidget> {
  @override
