...
import 'package:talent_link/src/presentation/screens/half_day_details/widgets/half_day_details_employee_widget.dart';
import 'package:talent_link/src/presentation/screens/half_day_details/widgets/half_day_details_widget.dart';
import 'package:talent_link/src/presentation/widgets/custom_button_widget.dart';

class HalfDayDetailsContentWidget extends StatefulWidget {
  ...
  const HalfDayDetailsContentWidget({
    super.key,
    this.isFromMyRequest = false,
    required this.getHalfDayDetails,
  ...
  @override
  State<HalfDayDetailsContentWidget> createState() =>
      _HalfDayDetailsContentWidgetState();
}

class _HalfDayDetailsContentWidgetState
    extends State<HalfDayDetailsContentWidget> {
  @override
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        HalfDayDetailsWidget(getHalfDayDetails: widget.getHalfDayDetails),
        HalfDayDetailsEmployeeWidget(
            getHalfDayDetails: widget.getHalfDayDetails),
