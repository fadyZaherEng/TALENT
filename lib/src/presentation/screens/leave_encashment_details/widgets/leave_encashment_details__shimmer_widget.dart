...
class LeaveEncashmentDetailsShimmerWidget extends StatefulWidget {
  final bool isFromMyRequest;
  final int transactionId;
  final int referenceId;

  const LeaveEncashmentDetailsShimmerWidget({
    super.key,
  ...
  @override
  State<LeaveEncashmentDetailsShimmerWidget> createState() =>
      _LeaveEncashmentDetailsShimmerWidgetState();
}

class _LeaveEncashmentDetailsShimmerWidgetState
    extends State<LeaveEncashmentDetailsShimmerWidget> {
  @override
