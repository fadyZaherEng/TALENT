...
class IndemnityEncashmentDetailsShimmerWidget extends StatefulWidget {
  final bool isFromMyRequest;
  final int transactionId;
  final int referenceId;

  const IndemnityEncashmentDetailsShimmerWidget({
    super.key,
  ...
  @override
  State<IndemnityEncashmentDetailsShimmerWidget> createState() =>
      _IndemnityEncashmentDetailsShimmerWidgetState();
}

class _IndemnityEncashmentDetailsShimmerWidgetState
    extends State<IndemnityEncashmentDetailsShimmerWidget> {
  @override
